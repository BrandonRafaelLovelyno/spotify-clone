    ...
    <div className="flex bg-black w-full h-fit py-4 items-center px-5">
      <div className="flex-1">
        <div className="flex w-fit items-center gap-x-5">
          <SongBook song={song} hidePlayButton={true} />
          <LikeButton song_id={song.id} />
        </div>
      </div>
      <div className="flex flex-1 justify-center gap-x-3">
        <div className="text-neutral-300 rounded-full p-2 hover:text-white duration-200 max-md:hidden" onClick={onPlayPrevious}>
          <AiOutlineStepBackward size={27} />
        </div>
        <div className="text-black bg-white rounded-full p-2 hover:scale-110 duration-200" onClick={handlePlay}>
          <MidIcon size={27}/>
        </div>
        <div className="text-neutral-300 rounded-full p-2 hover:text-white duration-200" onClick={onPlayNext}>
